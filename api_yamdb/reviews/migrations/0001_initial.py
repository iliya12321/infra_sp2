# Generated by Django 2.2.16 on 2022-12-13 18:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(related_name='titles', through='reviews.GenreAndTitle', to='reviews.Genre', verbose_name='Название жанра')),
            ],
            options={
